...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASEPC] = LAYOUT_compy_jis(
        ...
        KC_GRV,    JP_1,   JP_2,   JP_3,   JP_4,   JP_5,   JP_6,   JP_7,   JP_8,   JP_9,   JP_0,JP_MINS,JP_CIRC, JP_YEN,KC_BSPC,      KC_HOME, TG(_NMPDPC), KC_END,
...
static void render_logo(void) {
    static const char PROGMEM compyx_logo[] = {
        ...
        0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0x20, 0x00
    };
...
static void render_layer(void) {
    static const char PROGMEM g_layer[] = {
        0x01, 0x02, 0x03, 0x04, 0x00
    };

    oled_write_P(g_layer, false);
}

static void render_pc(void) {
    static const char PROGMEM g_pc[] = {
        0x05, 0x06, 0x07, 0x00
    };

    oled_write_P(g_pc, false);
}

static void render_x68k(void) {
    static const char PROGMEM g_x68k[] = {
        0x0B, 0x0C, 0x0D, 0x00
    };

    oled_write_P(g_x68k, false);
}

static void render_num(void) {
    static const char PROGMEM g_num[] = {
        0x08, 0x09, 0x0A, 0x00
    };

    oled_write_P(g_num, false);
}
...
static void render_hira_off(void) {
    static const char PROGMEM hira_off[] = {
        0xCD, 0xCE, 0xCF, 0x00
    };
